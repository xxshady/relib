  ...
  for item in imports_trait.items {
    ...
    let function_body = if pub_imports {
      ...
      let (return_type, post_fn_decl, read_return_value) = if needs_box {
        (
          ...
          quote! {
            #[allow(non_upper_case_globals)]
            #[unsafe(no_mangle)]
            static mut #post_mangled_ident: unsafe extern "C" fn(return_value_ptr: *mut #return_type) = ____post_placeholder____;

            unsafe extern "C" fn ____post_placeholder____(_: *mut #return_type) {
              unreachable!();
            }
          },
          quote! {
            // TEST
            println!("[module] cloning from box");
            dbg!();
        ...
        (
          ...
          quote! {
            // TEST
            println!("[module] reading value as-is");
            dbg!();
      ...
      quote! {
        ...
        unsafe extern "C" fn ____placeholder____(
          _: *mut bool,
          #inputs
